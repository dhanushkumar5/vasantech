    ...
    <section className="w-full bg-surface-container-low py-space-3xl" id="why-choose-us">
      <div className="max-w-container-max mx-auto px-gutter-mobile lg:px-gutter-desktop space-y-space-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-space-lg">
          <div className="p-space-lg rounded-xl bg-surface-container-lowest border border-outline-variant/30 space-y-space-xs shadow-sm">
          ...
          <div className="p-space-lg rounded-xl bg-surface-container-lowest border border-outline-variant/30 space-y-space-xs shadow-sm">
            <div className="w-12 h-12 rounded-lg bg-surface-container text-secondary flex items-center justify-center">
              <span className="material-symbols-outlined text-[28px]">laptop_mac</span>
            </div>
            <h3 className="font-headline-sm text-headline-sm text-primary">Computer &amp; Laptop Support</h3>
            <p className="font-body-sm text-body-sm text-on-surface-variant">
          ...
          <div className="p-space-lg rounded-xl bg-surface-container-lowest border border-outline-variant/30 space-y-space-xs shadow-sm">
            ...
            <h3 className="font-headline-sm text-headline-sm text-primary">New &amp; Refurbished Systems</h3>
            <p className="font-body-sm text-body-sm text-on-surface-variant">
          ...
          <div className="p-space-lg rounded-xl bg-surface-container-lowest border border-outline-variant/30 space-y-space-xs shadow-sm">
            ...
            <h3 className="font-headline-sm text-headline-sm text-primary">Phone &amp; WhatsApp Support</h3>
            <p className="font-body-sm text-body-sm text-on-surface-variant">
          ...
          <div className="p-space-lg rounded-xl bg-surface-container-lowest border border-outline-variant/30 space-y-space-xs shadow-sm">
            ...
            <h3 className="font-headline-sm text-headline-sm text-primary">Local Support in Kumbakonam</h3>
            <p className="font-body-sm text-body-sm text-on-surface-variant">
